...
// grab the 10 pieces of info. from the admin page and put them here
   if(!question || !points || !answerOne || !correct || !answerTwo || !correct || !answerThree 
       || !correct || !answerFour || !correct) {
 ...
 console.log(jsonObject)
    ...
    fetch("localhost:5000/write-question", { // has to match the listener called write question on the services.js page
        method: "POST",
        headers: {
    ...
    .then(data => {
        ...
        if(data.msg === "SUCCESS") {
           // document.getElementById("clear").click();  // if successfully inserted ?, then will send the answer over
        }
    })
    .catch(error => {
